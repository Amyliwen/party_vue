<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" label="中文名" prop="chineseName" style="width: 60px;"></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form class="small-space" :model="tempUser" label-position="left" label-width="80px"
        ...
        <el-form-item label="中文名" required>
          <el-input type="text" v-model="tempUser.chineseName">
          </el-input>
        </el-form-item>
        <el-form-item label="头像" >
          <el-upload
            class="avatar-uploader"
            action="/user/addPhoto"
            ref="photoURL"
            :show-file-list="false"
            :on-success="handleAvatarSuccess"
            :before-upload="beforeAvatarUpload">
            <img v-if="tempUser.photoURL" :src="tempUser.photoURL" class="avatar">
...
<script>
  // 说白了mapState，mapGetters,mapMutations,mapActions
  ...
  export default {
    ...
    methods: {
      ...
      showUpdate($index) {
        ...
        this.tempUser.chineseName = user.chineseName;
      ...
      createUser() {
        // this.tempUser.photoURL = this.$refs.photoURL.submit();
        //添加新用户
        this.api({
          url: "/user/addUser",
          method: "post",
      ...
      handleAvatarSuccess(file, res) {
        ...
        // 其中包含一个表示参数中给出的对象的URL。这个 URL 的
        // 生命周期和创建它的窗口中的 document 绑定。这个新的URL
        // 对象表示指定的 File 对象或 Blob 对象。
        // this.tempUser.photoURL = URL.createObjectURL(file.raw);
      },
